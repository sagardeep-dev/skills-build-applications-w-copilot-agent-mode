...
correct the urls if there is any issue in setting the root and it is asking to Use prompt files to define repeatable tasks and workflows. kindly check and resolve all the issues